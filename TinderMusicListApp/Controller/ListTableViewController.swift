...
class ListTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        //userIDと名前を渡して、渡されたControllerでIDからusers.idで全部取得して、userNameのListとして表示させる準備
        let otherVC = self.storyboard?.instantiateViewController(identifier: "othreList") as! OtherPersonListViewController
